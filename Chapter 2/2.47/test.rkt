...
(define frame-l (make-frame-l (make-vect 1 1)
                              (make-vect 2 2)
                              (make-vect 2 1)))
...
(check-expect (get-origin-l frame-l) '(1 . 1))
(check-expect (get-origin-c frame-c) '(1 . 1))
(check-expect (get-edge1-l frame-l) '(2 . 2))
(check-expect (get-edge1-c frame-c) '(2 . 2))
(check-expect (get-edge2-l frame-l) '(2 . 1))
